...
export default function BreakpointEngine() {
  ...
  return <>
    ...
    <div className="simulation-banner"><b>REAL-WORLD-LIKE SIMULATION</b><span>Two-fold dilution MICs and organism–drug profiles mimic bench behavior. Outputs remain synthetic—not surveillance data or official breakpoints—and must never be used for clinical reporting.</span></div>

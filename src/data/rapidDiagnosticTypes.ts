...
export interface BcidCompatibilityRule { organismId: string; markerId: string; compatibility: BcidCompatibility; explanation: string; sourceIds: string[]; reviewProvenance?: QualifiedReviewProvenance }

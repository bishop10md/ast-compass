...
const rule = (organismId: string, markerId: string, compatibility: BcidCompatibility = "primary", explanation = "Relevant BCID organism–marker interpretation context."): BcidCompatibilityRule => ({ organismId, markerId, compatibility, explanation, sourceIds: sources });
